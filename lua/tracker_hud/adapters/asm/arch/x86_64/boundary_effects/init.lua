-- lua/tracker_hud/adapters/asm/arch/x86_64/boundary_effects/init.lua
--
-- x86-64 boundary-effect aggregator.
--
-- Every boundary-effect rule is categorized, Tree-sitter-first, and
-- mnemonic-indexed.
...
merge_indexed_rules(require(
    "tracker_hud.adapters.asm.arch.x86_64.boundary_effects.system_calls"
))
