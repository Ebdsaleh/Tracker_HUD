    ...
    ["retn"] = {
        {
            ...
            effect = {
                ...
                offset_delta = 8,
                size = 8,
                role = "restored from near return address by retn",
            },
        },
        {
            syntax = {
    ...
    ["retq"] = {
        {
            ...
            effect = {
                ...
                offset_delta = 8,
                size = 8,
                role = "restored from quadword return address by retq",
            },
        },
        {
            syntax = {
    ...
    ["retl"] = {
        {
            ...
            effect = {
                ...
                offset_delta = 4,
                size = 4,
                role = "restored from long return address by retl",
            },
        },
        {
            syntax = {
    ...
    ["retw"] = {
        {
            ...
            effect = {
                ...
                offset_delta = 2,
                size = 2,
                role = "restored from word return address by retw",
            },
        },
        {
            syntax = {
